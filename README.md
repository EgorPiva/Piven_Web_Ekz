...
После инициализации в каталоге также появляются несколько демо-книг с обложками, чтобы можно было сразу показать поиск, карточки книг, отзывы и админские действия.
